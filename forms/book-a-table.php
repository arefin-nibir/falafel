<?php
  ...
  */
  ...
  $book_a_table->subject = "Nouvelle demande de réservation de table depuis le site";
  ...
  */
  ...
  $book_a_table->add_message( $_POST['name'], 'Nom');
  $book_a_table->add_message( $_POST['email'], 'Email');
  $book_a_table->add_message( $_POST['phone'], 'Téléphone', 4);
  $book_a_table->add_message( $_POST['date'], 'Date', 4);
  $book_a_table->add_message( $_POST['time'], 'Heure', 4);
  $book_a_table->add_message( $_POST['people'], 'Nombre de personnes', 1);
